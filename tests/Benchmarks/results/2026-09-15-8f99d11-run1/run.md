...
- Toolchain=InProcessNoEmitToolchain, InvocationCount=1, IterationCount=20,
  ...
  `## Constraints`).
- Position in the timed comparison sequence: 1st of 3 (order after, before, after).
- Ended: 2026-09-15T12:09:28+03:00. BenchmarkDotNet total run time 11:41.
